...
import '../quraan_widgets/most_recently_card_widget.dart';
import '../quraan_widgets/quraan_details_view.dart';
import '../quraan_widgets/sura_card_widget.dart';
                ...
                SizedBox(
                  ...
                  child: BlocBuilder<MostRecentCubit, MostRecentState>(
                    builder: (context, state) {
                      if (state is EmptyRecentState){
                        return Center(
                            child: Text(
                              "choose Sura to add here",
                              style: textTheme.bodyMedium?.copyWith(
                                  color: CupertinoColors.systemGrey3,
                                  fontWeight: FontWeight.w200),
                            ));
                      }
                      else if(state is GetRecentState){
